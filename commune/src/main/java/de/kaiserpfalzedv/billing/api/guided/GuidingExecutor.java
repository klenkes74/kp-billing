...
public interface GuidingExecutor {
    GuidedMeteredRecord execute(RawMeteredRecord record) throws GuidingBusinessExeption;

    GuidedTimedRecord execute(RawTimedRecord record) throws GuidingBusinessExeption;
}
