 ...
 * @since 2018-02-17
 */
public class TarifingException extends BillingRecordholdingBusinessException {
    private static final long serialVersionUID = 4006769743869075084L;

    public TarifingException(GuidedBaseRecord billingRecord, String message) {
        super(billingRecord, message);
    }

    public TarifingException(GuidedBaseRecord billingRecord, String message, Throwable cause) {
