...
public class GuidedMeteredRecordImpl extends BaseMeteredBillingRecordImpl implements GuidedMeteredRecord {
    private static final long serialVersionUID = 7907921147453648348L;
    ...
    @Override
    public RatedMeteredRecord execute(RatingExecutor executor) throws RatingBusinessExeption {
