 ...
 * @since 2018-02-11
 */
public class GuidedTimedRecordImpl extends BaseTimedBillingRecordImpl implements GuidedTimedRecord {
    private static final long serialVersionUID = 4096539351865698208L;

    private final Customer customer;
    private final ProductRecordInfo productInfo;

    public GuidedTimedRecordImpl(
            final UUID id,
    ...
    @Override
    public RatedTimedRecord execute(RatingExecutor executor) throws RatingBusinessExeption {
