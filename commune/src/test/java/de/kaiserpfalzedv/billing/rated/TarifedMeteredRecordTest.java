...
import de.kaiserpfalzedv.billing.guided.impl.ProductInfoBuilder;
import de.kaiserpfalzedv.billing.guided.impl.ProductRecordInfoBuilder;
import de.kaiserpfalzedv.billing.rated.impl.TarifBuilder;
import de.kaiserpfalzedv.billing.rated.impl.TarifedRecordBuilder;
...
public class TarifedMeteredRecordTest {
    ...
    private static final TarifedMeteredRecord TARIFED_METERED_RECORD = new TarifedRecordBuilder<TarifedMeteredRecord>()
            .setId(ID)
    ...
    private TarifedRecordBuilder<TarifedMeteredRecord> service;

    @BeforeClass
    public static void setUpClass() {
        MDC.put("test", TarifedMeteredRecord.class.getSimpleName());
    ...
    public void generateSimpleTarifedMeteredRecord() {
        ...
        TarifedMeteredRecord result = service
                .setProductInfo(PRODUCT_RECORD_INFO)
                .setCustomer(CUSTOMER)
                .setMeteredValue(METERED_VALUE)
                .setTarif(TARIF)
    ...
    public void copyTarifedMeteredRecord() {
        ...
        TarifedMeteredRecord result = service.copy(TARIFED_METERED_RECORD).build();
        LOG.debug("result: {}", result);
    ...
    public void setUp() throws Exception {
        service = new TarifedRecordBuilder<>();
    }
