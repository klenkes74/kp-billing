...
public class TarifedTimedRecordTest {
    ...
    private static final TarifedTimedRecord TARIFED_TIMED_RECORD = new TarifedRecordBuilder<TarifedTimedRecord>()
            .setId(ID)
    ...
    private TarifedRecordBuilder<TarifedTimedRecord> service;

    @BeforeClass
    public static void setUpClass() {
        MDC.put("test", TarifedTimedRecord.class.getSimpleName());
    ...
    public void generateSimpleTarifedMeteredRecord() {
        ...
        TarifedTimedRecord result = service
                .setProductInfo(PRODUCT_RECORD_INFO)
                .setCustomer(CUSTOMER)
                .setMeteredStartDate(METERED_START_DATE)
                .setMeteredDuration(METERED_DURATION)
    ...
    public void copyTarifedTimedRecord() {
        ...
        TarifedTimedRecord result = service.copy(TARIFED_TIMED_RECORD).build();
        LOG.debug("result: {}", result);
